...
INSERT INTO `shnmm_tbl_students` (`STUDENT_ID`, `ACADEMIC_YEAR`, `SHIFT`, `SECTION`, `CLASS`, `ROLL`, `NAME_EN`, `NAME_BN`, `BLOOD_GROUP`, `RELIGION`, `GENDER`, `DATE_OF_BIRTH`, `BIRTH_REG_NO`, `FATHER_NAME`, `FATHER_MOBILE_NUMBER`, `FATHER_NID`, `MOTHER_NAME`, `MOTHER_MOBILE_NUMBER`, `MOTHER_NID`, `PRESENT_ADDRESS`, `PERMANENT_ADDRESS`, `PIC`, `STATUS`, `REMARK`) VALUES
...
(2504143, '2025', 'N/A', 'N/A', 'HIFZ-RIVISION', '001', 'MD. SAJJAD SHIKDER', 'মোঃ সাজ্জাদ শিকদার', 'N/A', 'ISLAM', 'MALE', '01/12/2012', 'N/A', 'MD. SAMIM SIKDER', '01727801075', 'N/A', 'N/A', '01756986990', 'N/A', 'N/A', 'N/A', 'views/theme/img/2504143.png', 'IN-ACTIVE', '৫ মাসের বেতন দেওয়া হয়নি। অনেকবার কল করা হয়েছিলো, কোন উত্তর পাওয়া যায়নি। \r\n\r\nসুতরাং, সিদ্ধান্তক্রমে ভর্তি বাতিল করা হল।'),
