...
<main class="app-main">
  ...
  <div class="app-content-header">
    ...
    <div class="container-fluid">
      <!--begin::Row-->
      <div class="row">
        <div class="col-sm-6"><h3 class="mb-0">Students Profile Details</h3></div>
        <div class="col-sm-6">
            ...
            <!--Profile----------------------------------------------------------------------------------------------------------->
                          <div class="tab-pane fade active show p-3" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                foreach($result as $data){
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 text-center">
                                            <div class="card">
                                                    <p class="fs-3 w-auto fw-bold p-3 border-bottom">Photo's</p>
                                                <div class="row p-2">
                                                    <div class="col-sm-4">
                                                        <img src="<?= $data['PIC'] ?>" class="img-fluid img-thumbnail" style="width:150px; height:150px">
                                                        <p class="w-auto fw-bold p-1 mt-2">Student Photo</p>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <img src="" class="img-fluid img-thumbnail" style="width:150px; height:150px">
                                        ...
                                        <div class="col-md-6 text-center">
                                            <fieldset style="border-image: linear-gradient(to right, red, orange) 30;border-width: 4px;border-style: solid;">
                                                <legend class="w-auto text-nowrap"><strong>Academic Information</strong></legend>
                                                <table class="table-bordered table-striped">
                                                    <tbody><tr>
                                                        <th class="text-left" style="width:30%;">Academic Year</th>
                                                        <td class="text-center">:</td>
                                                        <td class="text-left">2025</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="text-left" style="width:30%;">Class</th>
                                                        <td class="text-center">:</td>
                                                        <td class="text-left">PLAY</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="text-left" style="width:30%;">Section</th>
                                                        <td class="text-center">:</td>
                                                        <td class="text-left">N/A</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="text-left" style="width:30%;">Roll</th>
                                                        <td class="text-center">:</td>
                                                        <td class="text-left">001</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="text-left" style="width:30%;">Student ID</th>
                                                        <td class="text-center">:</td>
                                                        <td class="text-left">10-25-001</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="text-left" style="width:30%;">Status</th>
                                                        <td class="text-center">:</td>
                                                                                                                <td class="text-center" style="background-color: green; color: white;">Active</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="text-left" style="width:30%;">Last Update</th>
                                                        <td class="text-center">:</td>
                                                        <td class="text-left">12 February 2025, 8:37 am</td>
                                                    </tr>
                                                </tbody></table>
                                            <fieldset>
                                        </fieldset></fieldset></div>
                            ...
                            <div class="row" style="padding-bottom: 10px;">
                                <div class="col-md-6 text-center">
                                    <fieldset style="border-image: linear-gradient(to right, red, orange) 30;border-width: 4px;border-style: solid;">
                                        <legend class="w-auto text-nowrap"><strong>Student Information</strong></legend>
                                        <table class="table-bordered table-striped">
                                            <tbody><tr>
                                                <th class="text-left" style="width:30%;">Student Name</th>
                                                <td class="text-center">:</td>
                                                <td class="text-left">MD MUNTASIR ARYAN</td>
                                            </tr>
                                            <tr>
                                                <th class="text-left" style="width:30%;">শিক্ষার্থীর নাম</th>
                                                <td class="text-center">:</td>
                                                <td class="text-left">মো: মুনতাসির আরিয়ান</td>
                                            </tr>
                                            <tr>
                                                <th class="text-left" style="width:30%;">Date of Birth</th>
                                                <td class="text-center">:</td>
                                                <td class="text-left">16/08/2019</td>
                                            </tr>
                                            <tr>
                                                <th class="text-left" style="width:30%;">Birth Reg. No.</th>
                                                <td class="text-center">:</td>
                                                <td class="text-left">20191591610141196</td>
                                            </tr>
                                            <tr>
                                                <th class="text-left" style="width:30%;">Blood Group</th>
                                                <td class="text-center">:</td>
                                                <td class="text-left"></td>
                                            </tr>
                                            <tr>
                                                <th class="text-left" style="width:30%;">Religion</th>
                                                <td class="text-center">:</td>
                                                <td class="text-left">Islam</td>
                                            </tr>
                                            <tr>
                                                <th class="text-left" style="width:30%;">Gender</th>
                                                <td class="text-center">:</td>
                                ...
                                <div class="col-md-6 text-center">
                                    <fieldset style="border-image: linear-gradient(to right, red, orange) 30;border-width: 4px;border-style: solid;">
                                        <legend class="w-auto text-nowrap"><strong>Parents Information</strong></legend>
                                        <table class="table-bordered table-striped">
                                            <tbody><tr>
                                                <th class="text-left" style="width:30%;">Father's Name</th>
                                                <td class="text-center">:</td>
                                                <td class="text-left">MD RASHED HOSSAIN</td>
                                            </tr>
                                            <tr>
                                                <th class="text-left" style="width:30%;">Father's Mobile</th>
                                                <td class="text-center">:</td>
                                                <td class="text-left">01884051538</td>
                                            </tr>
                                            <tr>
                                                <th class="text-left" style="width:30%;">Father's N.I.D</th>
                                                <td class="text-center">:</td>
                                                <td class="text-left"></td>
                                            </tr>
                                            <tr>
                                                <th class="text-left" style="width:30%;">Mother's Name</th>
                                                <td class="text-center">:</td>
                                                <td class="text-left">RINA AKTHER</td>
                                            </tr>
                                            <tr>
                                                <th class="text-left" style="width:30%;">Mother's Mobile</th>
                                                <td class="text-center">:</td>
                                                <td class="text-left"></td>
                                            </tr>
                                            <tr>
                                                <th class="text-left" style="width:30%;">Mother's N.I.D</th>
                                                <td class="text-center">:</td>
                                                <td class="text-left"></td>
                                            </tr>
                                        </tbody></table>
                            ...
                            <div class="row" style="padding-bottom: 10px;">
                                <div class="col-md-6 text-center">
                                    <fieldset style="border-image: linear-gradient(to right, red, orange) 30;border-width: 4px;border-style: solid;">
                                        <legend class="w-auto text-nowrap"><strong>Address</strong></legend>
                                        <table class="table-bordered table-striped">
                                            <tbody><tr>
                                                <th class="text-left" style="width:30%;">Present Address</th>
                                                <td class="text-center">:</td>
                                                <td class="text-left"></td>
                                            </tr>
                                            <tr>
                                                <th class="text-left" style="width:30%;">Permanant Address</th>
                                                <td class="text-center">:</td>
                                                <td class="text-left"></td>
                                            </tr>
                                        </tbody></table>
